    ...
    >
      ...
      >
        ...
        <div className="space-y-6 text-gray-300">
          ...
          <p>
            Open to collaborations and new opportunities, I aim to expand my expertise in <span className="text-rose-500 font-semibold">Full-Stack development</span> while creating meaningful digital experiences.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-300">
                JavaScript, Node.js, Express.js, MongoDB, React, Next.js, Tailwind CSS
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-300">Become a professional Full-Stack Engineer</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-300">Collaboration on Full-Stack projects</p>
            </div>
          </motion.div>
        </div>
      </motion.div>
